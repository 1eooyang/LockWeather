...
public class WeatherFragment extends BaseLFragment implements RxWeatherView, View.OnClickListener, ScrollViewLisenter {
                ...
                case 2:
                    if (Utils.isNet(getActivity())) {
                        if (mywebview != null) {
                            ...
                            mywebview.loadUrl("http://m.kirbatisun.com/?channel=0");
                        }
                    }
                    break;
            }
    ...
    private void manualMeasureHeight() {
        ...
        int webviewHeight = fullScreenHeight - Utils.getStatusBarHeight(getActivity()) - Utils.dip2px(getActivity(), 150);
        LinearLayout.LayoutParams layoutParams = new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, webviewHeight);
