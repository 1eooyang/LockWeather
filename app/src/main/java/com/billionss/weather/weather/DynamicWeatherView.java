...
public class DynamicWeatherView extends SurfaceView implements SurfaceHolder.Callback {
    ...
    public void onResume() {
        ...
        System.out.println("leo onResume");
        synchronized (mDrawThread) {
            mDrawThread.mRunning = true;
            mDrawThread.notify();
            System.out.println("leo onResume notify");
        }
    }

    public void onPause() {
        // Make sure the drawing thread is not running while we are paused.
        System.out.println("leo onPause");
      //  synchronized (mDrawThread) {
            mDrawThread.mRunning = false;
           // mDrawThread.notify();
            System.out.println("leo onPause notify");
      //  }
    }

    public void onDestroy() {
        // Make sure the drawing thread goes away.
        System.out.println("leo onDestroy");
        synchronized (mDrawThread) {
            mDrawThread.mQuit = true;
            mDrawThread.notify();
            System.out.println("leo onDestroy notify");
        }
    }
