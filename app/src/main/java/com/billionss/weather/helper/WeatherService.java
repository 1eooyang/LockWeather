...
//                .setSmallIcon(R.mipmap.ic_launcher);//设置通知小ICON
        ...
        if(mRemoteViews==null){
            ...
            mRemoteViews.setInt(R.id.tv_now_tmp, "setTextColor", Utils.isDarkNotificationTheme(context) ? Color.WHITE : Color.BLACK);
            mRemoteViews.setInt(R.id.tv_now, "setTextColor", Utils.isDarkNotificationTheme(context) ? Color.WHITE : Color.BLACK);
            mRemoteViews.setInt(R.id.tv_state, "setTextColor", Utils.isDarkNotificationTheme(context) ? Color.WHITE : Color.BLACK);
            mRemoteViews.setInt(R.id.tv_city, "setTextColor", Utils.isDarkNotificationTheme(context) ? Color.WHITE : Color.BLACK);
        }
